...
5. En mode connecté, si les cartes locales sont absentes, CartoFLU propose automatiquement de créer le répertoire et de télécharger **tout le fond** selon `local-basemap-download` (zone + niveaux de zoom).
